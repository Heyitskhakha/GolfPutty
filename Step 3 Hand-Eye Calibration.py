...
RECORD_FOLDER = 'C:/Users/skha/PycharmProjects/GolfPutty/Hand-Eye-Data'  # Default folder to save recordings, relative to the station folder

CAMERA_TYPE = CameraTypes.ROBODK_SIMULATED  # Camera type to be used
CAMERA_ROBODK_NAME = 'Doosan Robotics H2515'  # [Optional] Default name to use for the RoboDK camera
ROBOT_NAME = 'Cali'  # [Optional] Default name to use for the robot
