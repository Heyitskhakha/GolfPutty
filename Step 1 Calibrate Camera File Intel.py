...
CHECKERBOARD_SQUARE_SIZE = 25  # size of each square in mm
...
SQUARE_LENGTH = 24  # mm, length of one square
...
# Get the images
images_dir="C:/Users/skha/PycharmProjects/GolfPutty/Calibration_Files_CharUco/"
# Get the images
